# Tech Excel: Securely migrate Windows Server and SQL Server workloads to Azure hands-on lab step-by-step
...
In this hands-on lab, you will perform steps to migrate and secure Windows Server and SQL Server workloads to Azure. You will go through provisioning a Windows Server VM, migrating a SQL Server database to Azure SQL Managed Instance (SQL MI), secure Windows Server, and Azure Arc-enable an on-premises Windows Server VM.
...
Refer to the [Before the hands-on lab setup guide manual](0%20-%20Before%20the%20HOL.md) before continuing to the lab exercises.
