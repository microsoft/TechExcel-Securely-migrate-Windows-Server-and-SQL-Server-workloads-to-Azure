...
2. On the left, select **Bastion** under **Connect**.
    ...
    ![The virtual machine pane for the simulated on-premises hyper-v host VM is shown with the Bastion link under Operations highlighted.](../../Hands-on%20lab/images/portal-virtual-machine-connect-bastion-link.png "Bastion link under Operations")
